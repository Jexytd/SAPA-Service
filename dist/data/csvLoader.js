...
export const INFLASI_REDIRECT_CARD = `📌 *Informasi Data Inflasi / IHK*
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
export const PST_CONTACT_CARD = `🏛️ *LAYANAN KONSULTASI STATISTIK TERPADU (PST)*
...
export const GARDA_PORTAL_CARD = `📊 *PORTAL VISUALISASI DATA (GARDA)*
🏛️ *BPS KABUPATEN BANGKA*
━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Selamat datang di *GARDA (Galeri & Visualisasi Data)* BPS Kabupaten Bangka!

Portal GARDA menyajikan data statistik resmi dalam bentuk visualisasi grafik, dashboard interaktif, dan infografis yang menarik serta mudah dipahami:

📈 *Fitur Utama Portal GARDA:*
• Dashboard Interaktif Indikator Makro (Kemiskinan, Ketenagakerjaan, IPM, PDRB)
• Visualisasi Grafik & Tren Historis Tematik
• Akses Cepat Tabel Publikasi & Ringkasan Eksekutif Resmi BPS Bangka

🌐 *Akses Portal GARDA:*
👉 *Link Portal:* https://s.bps.go.id/GARDABANGKA
👉 *Website Resmi BPS:* https://bangkakab.bps.go.id
...
export const DEFAULT_FAQ_DATA = {
    ...
    "Pertanian dan Perkebunan": "🌾 *DATA PERTANIAN DAN PERKEBUNAN KAB. BANGKA*<br><br>🌾 *Komoditas Padi (Tahun 2025):*<br>• Luas Panen Padi: *2.979 hektar* (naik 59,99% / +1.117 ha dari tahun 2024 sebesar 1.862 ha)<br>• Produksi Padi: *7.949 ton GKG* (naik 60,78% / +3.005 ton GKG dari tahun 2024 sebesar 4.944 ton GKG)<br><br>💡 _Sumber: Data Statistik Pertanian BPS Kabupaten Bangka._",
    ...
    "Portal visualisasi data BPS Kab Bangka (GARDA)": GARDA_PORTAL_CARD,
    "GARDA": GARDA_PORTAL_CARD,
    "Portal Visualisasi Data": GARDA_PORTAL_CARD
};
import { getFAQDataFromStore } from './dbStore.js';
export function loadFAQData() {
    try {
        const storeFaq = getFAQDataFromStore();
        return { ...DEFAULT_FAQ_DATA, ...storeFaq };
    }
    catch (err) {
        return { ...DEFAULT_FAQ_DATA };
    }
}
export function saveFAQData(_data) {
    return true;
}
